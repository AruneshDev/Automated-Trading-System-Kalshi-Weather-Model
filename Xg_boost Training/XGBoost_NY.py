...
# # Load the dataset
# file_path = 'C:/Users/arune/Desktop/Common Task/New York City 2021-07-01 to 2024-03-24.csv'
...
# features_for_today = {'humidity', 'windgust',
#                       'cloudcover', 'tempmin', 'tempmax'}
# # Convert dictionary to DataFrame
# df_today = pd.DataFrame([features_for_today])
# # Predict and evaluate on the test set
# X_today_scaled = scaler.transform(
#     df_today[['Year', 'Month', 'Day', 'DayOfYear',
#               'WeekOfYear'] + features_to_include])
...
# # today_max_temp_pred = optimized_model.predict(X_test)
# print(f'Predicted max temperature for today: {today_max_temp_pred[0]}°F')
