...
# Load the dataset
file_path = 'C:/Users/sriha/OneDrive/Desktop/ML Common Task/Bergstrom International A... 2021-07-01 to 2024-03-17.csv'
...
# Feature selection
features_to_include = ['Year', 'Month', 'Day', 'DayOfYear', 'WeekOfYear', 'humidity', 'dew', 
                       'windgust', 'cloudcover', 'tempmin', 'solarenergy']
...
future_date_str = '2024-03-23'
features_means = {'humidity': 79.8, 'windgust': 12.8, 'cloudcover': 41.8, 'tempmin': 47, 'solarenergy' : 18.4, 'dew' : 53.8}
